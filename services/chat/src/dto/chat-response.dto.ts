...
export class MessageChatResponseDto {
  ...
  @ApiProperty({ type: MessageChatDto, nullable: true, description: 'Message chat payload' })
...
export class UserChatResponseDto {
  ...
  @ApiProperty({ type: UserChatDto, nullable: true, description: 'User chat payload' })
...
export class GeneralChatResponseDto {
  ...
  @ApiProperty({ type: GeneralChatDto, nullable: true, description: 'General platform chat payload' })
